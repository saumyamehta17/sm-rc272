...
class SnippetsControllerTest < ActionController::TestCase
  ...
  test "should create snippet" do
    assert_difference('Snippet.count') do
      post :create, snippet: { language: @snippet.language, name: @snippet.name, source_code: @snippet.source_code }
    end
  ...
  test "should update snippet" do
    patch :update, id: @snippet, snippet: { language: @snippet.language, name: @snippet.name, source_code: @snippet.source_code }
    assert_redirected_to snippet_path(assigns(:snippet))
  end
